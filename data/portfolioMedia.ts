...
export const PORTFOLIO_CASE_STUDIES: PortfolioCaseStudy[] = [
  {
    ...
    challenge:
      "Создать современный семейный дом с продуманной планировкой, инженерией и комфортной зоной отдыха.",
    result:
      "Проект доведён от концепции до строительства с понятной логикой этапов и контролем ключевых решений.",
    image: "/portfolio/projects/project-04.webp",
    blurDataURL: PORTFOLIO_IMAGE_BLUR_DATA_URL,
  },
  {
    ...
    challenge:
      "Объединить выразительную архитектуру, энергоэффективность и практичную планировку для постоянного проживания.",
    result:
      "Дом получил цельный архитектурный образ, удобную структуру помещений и подготовку под инженерные системы.",
    image: "/portfolio/projects/project-02.webp",
    blurDataURL: PORTFOLIO_IMAGE_BLUR_DATA_URL,
  },
  {
  ...
  },
  {
    ...
    duration: "по проекту",
    challenge:
      "Адаптировать архитектурную идею под участок, сценарии жизни семьи и будущие инженерные решения.",
    result:
      "Сформирована понятная концепция дома, которую можно последовательно реализовать в строительстве.",
    image: "/portfolio/projects/project-01.webp",
    blurDataURL: PORTFOLIO_IMAGE_BLUR_DATA_URL,
  },
];
